...
CLASS_NAMES = ['fm_bridging','foreign_material','foreign_material_2','foreign_object','metal_lifting','missing_metal','passivation','passivation_2','scum','substrate_hole','substrate_scratch','top_metal_scratch']

class NGC_Defect_Dataset(Dataset):
